...
<img src=".\Redis实战篇.assets\1653560986599.png" alt="1653560986599" style="zoom: 67%;" />



优化方案：<font color='red'>我们将逻辑判断放入到redis中，比如是否库存足够，比如是否一人一单，这样的操作，只要这种逻辑可以完成，就意味着我们是一定可以下单完成的</font>，我们只需要进行快速的逻辑判断，根本就不用等下单逻辑走完，我们直接给用户返回成功， 再在后台开一个线程，后台线程慢慢的去执行queue里边的消息，这样程序不就超级快了吗？而且也不用担心线程池消耗殆尽的问题，因为这里我们的程序中并没有手动使用任何线程池，当然这里边有两个难点
...
![image-20230508105044572](.\Redis实战篇.assets\image-20230508105044572.png)

![image-20230508105056775](.\Redis实战篇.assets\image-20230508105056775.png)
