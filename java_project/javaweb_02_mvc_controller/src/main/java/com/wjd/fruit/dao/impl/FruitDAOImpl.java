package com.wjd.fruit.dao.impl;

import com.wjd.fruit.dao.FruitDAO;
import com.wjd.fruit.dao.base.BaseDAO;
...
public class FruitDAOImpl extends BaseDAO<Fruit> implements FruitDAO {
    ...
    public List<Fruit> getFruitList(Integer pageNo) {
        return super.executeQuery("select * from t_fruit limit ? , 10", (pageNo - 1) * 10);
    }

    @Override
    public List<Fruit> getFruitList(String keyword, Integer pageNo) {
        return super.executeQuery("select * from t_fruit where fname like ? limit ? , 10", "%" + keyword + "%", (pageNo - 1) * 10);
    }
