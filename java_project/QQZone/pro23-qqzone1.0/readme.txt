...
5.QQZone登录功能实现出现的四个错误：
 ...
 4）Can not set com.wjd.qqzone.pojo.UserBasic field com.wjd.qqzone.pojo.Topic.author to java.lang.Integer
...
5. 目前我们进行javaweb项目开发的“套路”是这样的：
   ...
   4. 开发具体的业务模块：
      ...
      6） Controller类的编写规则
          ...
          <bean id="user" class="com.wjd.qqzone.controllers.UserController>
